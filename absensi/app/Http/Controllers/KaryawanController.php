...
}*/
{
    ...
    public function index(Request $request)
    {
         if($request->has('search')){
             $data_karyawan = \App\Karyawan::where('nama','LIKE','%'.$request->search.'%')->get();
         }else{
             $data_karyawan = \App\Karyawan::all();
         }return view('karyawan.index',['data_karyawan'=>$data_karyawan]);
     ...
     //$data_karyawan = Karyawan::where('id')->get();
        ...
        ->join('posisi', 'posisi.id', '=', 'karyawan.jabatan_id')
   ...
   public function jadwal(Request $request)
    {   
        ...
        //select absensi.*, karyawan.nama AS jadwal from absensi inner join karyawan on absensi.id = karyawan.id
     $data = DB::table('absensi')
       ->join('karyawan', 'karyawan.nama', '=', 'absensi.id')
       ->select('absensi.*', 'karyawan.nama AS Employe')
       ->where('absensi.id', '=', $id)
       ->get();

       return view('karyawan/jadwal', compact('data'));
    }
    /**
